...
dnd5e.config.skills.veh = {label: "Vehicle Handling" , ability: "dex"};
...
//Remove Weapon Types
delete dnd5e.config.weaponTypes.WeaponSimpleM;

//Adding weapon properties
//delete dnd5e.config.itemProperties.ada;
//dnd5e.Item.Property.Arc = "Arc";
dnd5e.config.itemProperties.arc = {label: "Arc", isPhysical = true};
dnd5e.config.validProperties.weapon.add("arc");
//dnd5e.validProperties.weapon: new Set([
  //  "arc"])
//dnd5e.config.itemProperties['bst'] = 'Burst Fire';
//dnd5e.config.itemProperties['dtp'] = 'Double Tap';
//dnd5e.config.itemProperties['het'] = 'Heat';
//dnd5e.config.itemProperties['hip'] = 'Hip Fire';
//dnd5e.config.itemProperties['snt'] = 'Silent';
//dnd5e.config.itemProperties['coi'] = 'Recoil';

//Adding weapon proficiencies
dnd5e.config.weaponProficiencies['ars'] = 'Assault Rifle';
dnd5e.config.weaponProficiencies['hps'] = 'Heavy Pistol';
dnd5e.config.weaponProficiencies['smg'] = 'SMG';
dnd5e.config.weaponProficiencies['sht'] = 'Shotgun';
dnd5e.config.weaponProficiencies['snp'] = 'Sniper Rifle';
dnd5e.config.weaponProficiencies['hvy'] = 'Heavy Weapon';
